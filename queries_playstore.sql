...
-- 12 -- 
SELECT * FROM analyticsORDER BY last_updated LIMIT 1;

-- 13 -- 
SELECT * FROM analytics WHERE price = (SELECT MAX(price) FROM analytics);

-- 14 -- 
SELECT * FROM analyticsORDER BY price DESC LIMIT 1;
...
-- 17 --
SELECT app_name, reviews, min_installs,  min_installs / reviews AS proportionFROM analyticsWHERE min_installs >= 100000 ORDER BY proportion DESC LIMIT 1;